const greetingMessages = `Assalamu'alaikum Warahmatullahi Wabarakatuh
...
const updateMessages = `Hai, Terimakasih telah mencari tau update acara saceri, untuk kegiatan kita yang berlangsung sekarang adalah {BELUM ADA MAAP YAK}
`
...
const liveMessage = `Hai, Terimakasih telah memilih untuk live konsul dengan Minceri. Silahkan ajukan detail konsulnya dan mohon kesediannya untuk menunggu Minceri membalas pesan anda.
`
